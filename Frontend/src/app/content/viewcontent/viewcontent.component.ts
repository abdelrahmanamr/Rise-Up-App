...
export class ViewContentComponent {
    ...
    DeleteContent(ident: string) {
        ...
        this.httpClient.delete(environment.apiUrl + 'Content/deleteContent/' + ident + ".." + JSON.parse(localStorage.getItem("userProps"))["_id"], config).subscribe(
            res => {
    ...
    deleteComment(id: string) {
        ...
        this.httpClient.delete(environment.apiUrl + 'Content/deleteComment/' + id + ".." + JSON.parse(localStorage.getItem("userProps"))["_id"], config).subscribe(res => {
    ...
    reportComment(id: string) {
        ...
        this.httpClient.post(environment.apiUrl + 'Content/makeReport/' + id, body, config).subscribe(res => {
